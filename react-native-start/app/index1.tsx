      ...
      <ScrollView>
        <View className="items-center justify-center mt-16 gap-6">
          <Image
            ...
            className="w-16 h-16"
          />
          <Text className="text-xl font-bold text-white">Welcome  Non</Text>
          <Text className="  text-white py-4">
            ชื่อ: <Text>{data.name}</Text>
          </Text>
          <Text className=" text-lg font-normal text-white py-1">{`ปี: ${data.year}`}</Text>
          <Button
            title="กด"
